...
# Initialize HTTP Graphics device for plot rendering
#hgd()
#hgd_browse()
#dev.off()
...
results_folder <- "./results/Giotto_30uM7738_results/ONTtranscripts"
...
# --------------------------------------
SpatialTrans_30uM7738_ONTtrans <- get10Xmatrix(
  "./30uM7738/analysis/wf-VISIUM/SR1040-610_30uM7738/transcript_raw_feature_bc_matrix", 
  gene_column_index = 2
)
...
trans_barcodes <- colnames(SpatialTrans_30uM7738_ONTtrans)
...
# --------------------------------------------------------------------------------------------
SpatialTrans_30uM7738_ONTtrans <- createGiottoObject(
  expression = SpatialTrans_30uM7738_ONTtrans, 
...
SpatialTrans_30uM7738_ONTtrans <- addGiottoImage(
  gobject = SpatialTrans_30uM7738_ONTtrans, 
...
SpatialTrans_30uM7738_ONTtrans@cell_metadata$cell$rna@metaDT <- 
  SpatialTrans_30uM7738@cell_metadata$cell$rna@metaDT[
    SpatialTrans_30uM7738@cell_metadata$cell$rna@metaDT$cell_ID %in% trans_barcodes, ]

# Step 7: Transfer spatial information from the original object
# -------------------------------------------------------------
SpatialTrans_30uM7738_ONTtrans@spatial_info <- SpatialTrans_30uM7738@spatial_info

# Step 8: Verify the updated Giotto object
# ----------------------------------------
str(SpatialTrans_30uM7738_ONTtrans)  # Check the structure of the new object

# Print summary of the updated Giotto object
print(SpatialTrans_30uM7738_ONTtrans)

# Optional: Verify dimensions of the new expression matrix
print(dim(SpatialTrans_30uM7738_ONTtrans@expression[["cell"]][["rna"]][["raw"]]@exprMat))
...
metadata <- getCellMetadata(gobject = SpatialTrans_30uM7738_ONTtrans, output = "data.table")
...
SpatialTrans_30uM7738_ONTtrans_tissue <- subsetGiotto(gobject = SpatialTrans_30uM7738_ONTtrans, cell_ids = in_tissue_barcodes)

# Print a summary of the subsetted Giotto object
print(SpatialTrans_30uM7738_ONTtrans_tissue)
...
```{r}
saveGiotto(SpatialTrans_30uM7738_ONTtrans, "./GiottoSuite_30uM7738_ONTtrans", overwrite = TRUE)
...
SpatialTrans_30uM7738_ONTtrans_statistics <- addStatistics(
  gobject = SpatialTrans_30uM7738_ONTtrans,
...
SpatPlot2_QC_nr_feats <- spatPlot2D(
  gobject = SpatialTrans_30uM7738_ONTtrans_statistics,
...
# Subset spots that are within the tissue area
in_tissue_barcodes <- metadata[in_tissue == 1]$cell_ID
SpatialTrans_30uM7738_ONTtrans <- subsetGiotto(gobject = SpatialTrans_30uM7738_ONTtrans, cell_ids = in_tissue_barcodes)
...
# Filter the Giotto object directly into SpatialTrans_30uM7738_ONTtrans_fil
SpatialTrans_30uM7738_ONTtrans <- filterGiotto(
  gobject = SpatialTrans_30uM7738_ONTtrans,
...
SpatialTrans_30uM7738_ONTtrans <- normalizeGiotto(
  gobject = SpatialTrans_30uM7738_ONTtrans,
  scalefactor = 6000,
  verbose = TRUE
)
...
SpatialTrans_30uM7738_ONTtrans <- addStatistics(
  gobject = SpatialTrans_30uM7738_ONTtrans,
  expression_values = "raw"
)
...
save_directory <- "./results/Giotto_30uM7738_results/ONTtranscripts/"
...
SpatialTrans_30uM7738_ONTtrans <- calculateHVF(
  gobject = SpatialTrans_30uM7738_ONTtrans,
...
SpatialTrans_30uM7738_ONTtrans <- runPCA(
  gobject = SpatialTrans_30uM7738_ONTtrans
)
...
my_features <- head(
  getFeatureMetadata(SpatialTrans_30uM7738_ONTtrans, output = "data.table")$feat_ID, 
  1000
)
...
SpatialTrans_30uM7738_ONTtrans <- runUMAP(
  gobject = SpatialTrans_30uM7738_ONTtrans,
...
SpatialTrans_30uM7738_ONTtrans <- runtSNE(
  gobject = SpatialTrans_30uM7738_ONTtrans,
  dimensions_to_use = 1:7,          # Use the first 10 dimensions
  verbose = TRUE
)
...
SpatialTrans_30uM7738_ONTtrans <- createNearestNetwork(gobject = SpatialTrans_30uM7738_ONTtrans, 
...
SpatialTrans_30uM7738_ONTtrans <- doLeidenCluster(
  gobject = SpatialTrans_30uM7738_ONTtrans,
...
```{r}
plotUMAP_LeidenClusters <- plotUMAP(gobject = SpatialTrans_30uM7738_ONTtrans,
...
plotUMAP_LeidenClusters_NN_network <- plotUMAP(gobject = SpatialTrans_30uM7738_ONTtrans,
         cell_color = "leiden_clus", 
...
## Plot in PCA Space
```{r}
plottSNE_LeidenClusters <- plotTSNE(gobject = SpatialTrans_30uM7738_ONTtrans,
         cell_color = "leiden_clus", 
         show_NN_network = FALSE, 
         save_plot = TRUE,                   # Save the plot
         save_param = base_save_parameters,  # Apply the save parameters
...
plottSNE_LeidenClusters_NN_network <- plotTSNE(gobject = SpatialTrans_30uM7738_ONTtrans,
         cell_color = "leiden_clus", 
         show_NN_network = TRUE, 
         save_plot = TRUE,                   # Save the plot
         save_param = base_save_parameters,  # Apply the save parameters
...
# Create a QC plot after filtering, using the same SpatialTrans_30uM7738_ONTtrans object
SpatPlot2_Leiden_clusters <- spatPlot2D(
  gobject = SpatialTrans_30uM7738_ONTtrans,  # Use the same object with statistics
...
```{r}
SpatialTrans_30uM7738_ONTtrans <- doLouvainCluster(SpatialTrans_30uM7738_ONTtrans)
...
```{r}
gini_markers <- findMarkers_one_vs_all(gobject = SpatialTrans_30uM7738_ONTtrans,
                                       method = "gini",
...
violinPlot_giniMarker <- violinPlot(SpatialTrans_30uM7738_ONTtrans, 
...
## Heatmap
```{r}
giniMarker_heatmap <- plotMetaDataHeatmap(SpatialTrans_30uM7738_ONTtrans, 
...
Spatial_Dist_giniMarker <- dimFeatPlot2D(
  SpatialTrans_30uM7738_ONTtrans, 
...
spatial_topgini_genes <- spatFeatPlot2D(SpatialTrans_30uM7738_ONTtrans, 
               expression_values = "scaled",
...
```{r}
scran_markers <- findMarkers_one_vs_all(gobject = SpatialTrans_30uM7738_ONTtrans,
                                       method = "scran",
                                       expression_values = "normalized",
                                       cluster_column = "leiden_clus")
...
output_path <- "./figures/paper_figures/supplementary/30uM7738scran_markers_with_symbols.csv"
...
```{r}
violinPlot_scranMarker <- violinPlot(SpatialTrans_30uM7738_ONTtrans, 
...
# Heatmap
```{r}
heatmap_scranMarkers <- plotMetaDataHeatmap(SpatialTrans_30uM7738_ONTtrans, 
...
```{r}
Spatial_Dist_scranMarkers <- dimFeatPlot2D(SpatialTrans_30uM7738_ONTtrans, 
              expression_values = "scaled",
...
spatial_topscran_genes <- spatFeatPlot2D(SpatialTrans_30uM7738_ONTtrans, 
               expression_values = "scaled",
...
```{r}
SpatialTrans_30uM7738_ONTtrans <- createSpatialNetwork(gobject = SpatialTrans_30uM7738_ONTtrans,
                                     method = "kNN", 
                                     k = 30,
...
```{r}
ranktest <- binSpect(SpatialTrans_30uM7738_ONTtrans, 
                     bin_method = "rank",
                     calc_hub = TRUE, 
                     hub_min_int = 5,
                     spatial_network_name = "spatial_network")
...
```{r}
spatial_prob_genes <- spatFeatPlot2D(SpatialTrans_30uM7738_ONTtrans, 
               expression_values = "scaled",
...
```{r}
heatmSpatialCorFeats(SpatialTrans_30uM7738_ONTtrans,
...
SpatialTrans_30uM7738_ONTtrans <- createMetafeats(SpatialTrans_30uM7738_ONTtrans, 
...
```{r}
spatCellPlot(SpatialTrans_30uM7738_ONTtrans,
...
SpatialTrans_30uM7738_ONTtrans <- runPCA(gobject = SpatialTrans_30uM7738_ONTtrans,
                       feats_to_use = spatial_genes,
                       name = "custom_pca")

SpatialTrans_30uM7738_ONTtrans <- runUMAP(SpatialTrans_30uM7738_ONTtrans, 
...
SpatialTrans_30uM7738_ONTtrans <- doLeidenCluster(gobject = SpatialTrans_30uM7738_ONTtrans, 
...
```{r}
spatPlot2D(SpatialTrans_30uM7738_ONTtrans, 
           cell_color = "custom_leiden",
           point_size = 3)
```

```{r}
plotUMAP(gobject = SpatialTrans_30uM7738_ONTtrans, 
         cell_color = "custom_leiden")
...
```{r}
HMRF_spatial_genes <- doHMRF(gobject = SpatialTrans_30uM7738_ONTtrans,
...
```{r}
SpatialTrans_30uM7738_ONTtrans <- addHMRF(gobject = SpatialTrans_30uM7738_ONTtrans, 
...
```{r}
Spat_Plot_HMRF <-spatPlot2D(gobject = SpatialTrans_30uM7738_ONTtrans, 
...
```{r}
n30uM7738_spatPlot <- spatPlot2D(gobject = SpatialTrans_30uM7738_ONTtrans,
                          cell_color = "leiden_clus",
                          show_image = FALSE,
                          return_plot = TRUE,
                          point_size = 7)
...
```{r}
plotInteractivePolygons(n30uM7738_spatPlot)
```

### Select the regions of interest and save the coordinates
```{r}
polygon_coordinates <- plotInteractivePolygons(n30uM7738_spatPlot)
```
...
```{r}
SpatialTrans_30uM7738_ONTtrans <- addGiottoPolygons(gobject = SpatialTrans_30uM7738_ONTtrans,
                                  gpolygons = list(giotto_polygons))
```

### Add the corresponding polygon IDs to the cell metadata
```{r}
SpatialTrans_30uM7738_ONTtrans <- addPolygonCells(SpatialTrans_30uM7738_ONTtrans,
                                polygon_name = "selections")
```
### Extract the coordinates and IDs from cells located within one or multiple regions of interest
```{r}
getCellsFromPolygon(SpatialTrans_30uM7738_ONTtrans,
                    polygon_name = "selections",
                    polygons = "tumoroid1")
```
...
```{r}
comparePolygonExpression(SpatialTrans_30uM7738_ONTtrans,
...
```{r}
compareCellAbundance(SpatialTrans_30uM7738_ONTtrans)
```
...
```{r}
spatFeatPlot2D(SpatialTrans_30uM7738_ONTtrans,
               expression_values = "scaled",
               group_by = "selections",
               feats = "VIM",
               point_size = 7)
...
```{r}
plotPolygons(SpatialTrans_30uM7738_ONTtrans,
             polygon_name = "selections",
             x =30uM7738_spatPlot)
...
# Transcripotmics analysis


```{r}
marker_results <- findMarkers_one_vs_all(gobject = SpatialTrans_30uM7738_ONTtrans, 
                                         method = 'scran', 
                                         expression_values = 'normalized',
                                         cluster_column = "leiden_clus")
```
